//
//  SignUpUserTypeLayout
//

import UIKit

open class SignUpUserTypeLayout: UICollectionViewFlowLayout {
    ...
    static func configureLayout(_ collectionView: UICollectionView, itemSize: CGSize, minimumLineSpacing: CGFloat) -> SignUpUserTypeLayout {
        let layout = SignUpUserTypeLayout()
    ...
    open override func targetContentOffset(forProposedContentOffset proposedContentOffset: CGPoint, withScrollingVelocity velocity: CGPoint) -> CGPoint {
        ...
        let offset = newOffsetX - self.collectionView!.contentOffset.x + 10
    ...
    open override func layoutAttributesForElements(in rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
        ...
        for (_, attributes) in superAttributes!.enumerated() {
            ...
            // bottom align
            newAttributes.frame.origin.y += (self.itemSize.height - newAttributes.frame.size.height)
